...
Ambassador.prototype.initialize = function() {
  /* eslint-disable */
  (function (m,b,s,y) { m[b] = m[b] || {}; m[b].uid = s; m[b].methods = ['ready', 'identify', 'track']; m[b].queue = []; m[b].factory = function(t) { return function() { var l = Array.prototype.slice.call(arguments); l.unshift(t); m[b].queue.push(l); return m[b].queue; };}; for (var t = 0; t < m[b].methods.length; t++) { y = m[b].methods[t]; m[b][y] = m[b].factory(y); }}.bind(this))(window, 'mbsy', this.options.uid);
  /* eslint-enable */
